//
import 'package:flutter_project/features/dashboard/domain/providers/dashboard_category_providers.dart';
...
final dashboardNotifierProvider =
    StateNotifierProvider<DashboardNotifier, DashboardState>((ref) {
  final repository = ref.watch(dashboardCategoryRepositoryProvider);
  return DashboardNotifier(repository)..fetchCategories();
});
